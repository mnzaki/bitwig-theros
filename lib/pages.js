...
//     onNote: an array of note values, eg: notes.pads, or [62, 66]
//             ONLY ONE OF 'on' or 'onNote' should be specified
//             'onNote' takes precedence.
//             Note MIDI messages do NOT cause a page switch, and the
//             the channel passed to the callback will be the last
//             active channel.
...
//     callback: function(idx_in_cc_array, chan, cc, new_val, last_val, noteOn)
//               callback to call when one there's a message with
//               a matching CC. If it's a note, the last argument is a boolean
//               signifying if it's noteOn or noteOff.
//     always: true/false
//                 if true, then mapping is active even when
//                 Controller.setEnabled(false) was called
//     indicate: function(chan, idx_in_cc_array) or bitwig control
//              a control to indicate in the GUI
//              if it's a function, it's evalued once for each cc
//              ONLY evaluted ONCE at startup
//    },
//    .....
